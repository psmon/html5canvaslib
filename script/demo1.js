...
function runDemo(app,demoType){
    ...
    switch(demoType){
        ...
        case "drawBall":
            director.backgroundColor="gray";
            var label = cocoApp.addLabel({string:"마우스를 이용해서 그림을 그려보세요",fontName:"Arial",fontSize:16,fontColor:"WHITE" });
        ...
        case "SpriteAnimation":
            ...
            var label = cocoApp.addLabel({string:"화가난다",fontName:"Arial",fontSize:26,fontColor:"WHITE" });
            label.position.x=200;
